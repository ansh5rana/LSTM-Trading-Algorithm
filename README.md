...
- Buying Logic: The algorithm buys stock (10% of current portfolio value) when the LSTM model predicts an upward price movement for the next day (atleast 1%) and the RSI indicates an oversold condition (below 40).
